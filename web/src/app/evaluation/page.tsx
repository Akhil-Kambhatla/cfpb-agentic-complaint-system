  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
      ...
      <Section
        ...
        subtitle="Bars show deviation from the average compliance risk score (0.66). Red = above average risk, blue = below average."
        delay={0.3}
      >
        <FairnessChart />
        <div style={{
          marginTop: 10, padding: "10px 14px", borderRadius: 8,
          background: "#fffbeb", border: "1px solid #fde68a", fontSize: 11, color: "#92400e", lineHeight: 1.6
        }}>
          <strong>Methodology note:</strong> Compliance risk scores are generated by our rule-based heuristic (product type + regulation/attorney/contact mentions). These reflect our system&apos;s assessment of relative risk, not externally validated regulatory data. The average (0.66) and per-product scores shown may differ from actual regulatory risk levels.
        </div>
        <Interpretation>
